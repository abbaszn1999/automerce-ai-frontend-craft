  ...
  public: {
    Tables: {
      ae_extraction_runs: {
        ...
        Relationships: [
          {
            foreignKeyName: "ae_extraction_runs_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "solution_projects"
      ...
      ae_product_data: {
        ...
        Relationships: [
          {
            foreignKeyName: "ae_product_data_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "solution_projects"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ae_product_data_run_id_fkey"
            columns: ["run_id"]
            isOneToOne: false
